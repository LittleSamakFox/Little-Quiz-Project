	...
	<body class="littlesamakfox">
        <div class="register">
            <div class="form-container">
                <form action="createaccount_db.php" method="post" class="container" id="needs-validation" novalidate>
                    <h2 class="text-center"><strong>계정 생성</strong></h2>
					<div class="form-group">
                        <input type="id" name="mem_id" class="form-control" id="id" placeholder="아이디" value="" required>
                        <div class="invalid-feedback">
                            아이디를 입력해주세요
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="email" name="mem_email" class="form-control" id="email" placeholder="이메일" value="" required>
                        <div class="invalid-feedback">
                            이메일을 입력해주세요
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="password" name="mem_password" class="form-control" id="password" placeholder="비밀번호" value="" required>
                        <div class="invalid-feedback">
                            비밀번호를 입력해주세요
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="password" name="mem_password2" class="form-control" id="password-repeat" placeholder="비밀번호를 다시 입력해주세요" value="" required>
                        <div class="invalid-feedback">
                            비밀번호를 다시 입력해주세요
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-check">
                            <label class="custom-control custom-checkbox">
                                ...
                                <span class="custom-control-description">계정 생성에 동의하십니까?</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <input button class="btn btn-primary btn-block" type="submit" value="계정 생성"></button>
                    </div><a href="/login.php" class="already">이미 계정이 있으십니까?</a>
                </form>
