	...
	<body class="littlesamakfox">
		...
		<div class="register">
            ...
            <div class="form-container">
                <form action="./writegame_db.php" method="post" style="padding-left:20px; padding-right:20px; margin-top:40px; margin-bottom:40px" enctype="multipart/form-data">
                        <div class="form-group">
							<input class="form-control" minlength="1" maxlength="15" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_initial" type="text" placeholder="퀴즈 이니셜을 입력해주세요">
							<input class="form-control" minlength="1" maxlength="15" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_name" type="text" placeholder="퀴즈 제목을 입력해주세요">
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_hint" type="text" placeholder="첫번째 힌트를 입력해주세요">
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_hint2" type="text" placeholder="두번째 힌트를 입력해주세요">
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_hint3" type="text" placeholder="세번째 힌트를 입력해주세요">
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_answer" type="text" placeholder="정답을 입력해주세요">
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_score" type="text" placeholder="점수를 입력해주세요">
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="game_limit" type="text" placeholder="한계를 입력해주세요">
							...
							<textarea class="form-control" minlength="1" maxlength="1000" required="" aria-required="true" style="ime-mode:active; margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de; min-height:250px" name="game_article" placeholder="본문을 입력해주세요 (최대 1,000자)"></textarea>
							<div align="center">
								<input class="btn btn-primary btn-pill mr-2 mb-5" type="submit" value="퀴즈 제작하기">
							</div>
						</div>
				</form>
            </div>
