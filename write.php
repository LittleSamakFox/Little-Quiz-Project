	...
	<body class="littlesamakfox">
		...
		<div class="register">
			<div class="intro">
                ...
                <h1 class="mb-4 mt-4 text-center">글쓰기 </h3>
                <p class="text-center">
            ...
            <div class="form-container">
                <form action="/write_db.php" method="post" style="padding-left:20px; padding-right:20px; margin-top:40px; margin-bottom:40px" enctype="multipart/form-data">
                        <div class="form-group">
							...
							<input class="form-control" minlength="1" maxlength="20" required="" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="subject" type="text" placeholder="제목을 입력해주세요(최대20자)">
							<input class="form-control" minlength="1" maxlength="10" required="true" aria-required="true" style="margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de" name="passwd" type="password" <?PHP
								...
								}?>" placeholder="비밀번호를 입력해주세요(최대10자)">
							...
							<textarea class="form-control" minlength="1" maxlength="1000" required="" aria-required="true" style="ime-mode:active; margin-bottom:25px; width:100%; height:40px; border: 1px solid #d9d9de; min-height:250px" name="article" placeholder="본문을 입력해주세요 (최대 1,000자)"></textarea>
							<div align="center">
								<input class="btn btn-primary btn-pill mr-2 mb-5" type="submit" value="글쓰기">
							</div>
						</div>
				</form>
            </div>
