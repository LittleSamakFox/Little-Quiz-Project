<html lang="ko">
	...
	<body class="littlesamakfox">
			<div class="login">
				<form method="post" class="container" id="needs-validation" novalidate action="login_db.php">
					<div class="illustration mb-5"><i class="icon ion-ios-locked-outline"></i></div>
					<div class="form-group">
						<input type="id" name="mem_id" class="form-control" id="mem_id" placeholder="아이디를 입력하세요" value="" required>
						<div class="invalid-feedback">
							아이디를 입력해주세요
						</div>
					</div>
					<div class="form-group">
						<input type="password" name="mem_password" class="form-control" id="mem_password" placeholder="비밀번호를 입력하세요" value="" required>
						<div class="invalid-feedback">
							비밀번호를 입력해주세요
						</div>
					</div>
					<div class="form-group">
						<label class="custom-control custom-checkbox">
							...
							<span class="custom-control-description">아이디 저장</span>
						</label>
					</div>
					<div class="form-group">
						<input button class="btn btn-primary btn-block" type="submit" value="로그인"></button>
					</div>
					<div class="container">
						<div class="row">
							<div class="col-md-6"><a href="/createaccount.php" class="forgot">계정 생성</a></div>
							<div class="col-md-6"><a href="/findaccount.php" class="forgot">계정/암호 찾기</a></div>
						</div>
					</div>
				</form>
			</div>
